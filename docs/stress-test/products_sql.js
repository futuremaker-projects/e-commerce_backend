...
export default function () {
    const url = urlWithQuery("/api/products/sql", PRODUCT_NAME);

    const res = http.get(url, { tags: { endpoint: "sql" } });
    ...
    latency.add(res.timings.duration, { endpoint: "sql" });
    okRate.add(ok, { endpoint: "sql" });
